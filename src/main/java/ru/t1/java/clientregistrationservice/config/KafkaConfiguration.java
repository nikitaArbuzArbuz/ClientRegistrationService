...
import ru.t1.java.clientregistrationservice.kafka.MessageDeserializer;
...
public class KafkaConfiguration<T> {
    ...
    public ConsumerFactory<String, TransactionDto> consumerListenerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "ru.t1.java.clientregistrationservice.model.dto.TransactionDto");
